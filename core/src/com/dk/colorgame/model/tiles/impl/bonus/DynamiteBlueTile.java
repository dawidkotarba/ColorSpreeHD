 ...
 */
public class DynamiteBlueTile extends ParticleAbstractTile {

    private final MainBoard mainBoard;

    public DynamiteBlueTile(SpriteBatch spriteBatch, MainBoard mainBoard) {
        super(spriteBatch, GraphicUtils.loadAnimation(Animations.ANIMATION_TILE_DYNAMITE_BLUE, 1 / 20f), Textures.IMG_DYNAMITE_ACTIVE_BLUE_TILE, Particles.PARTICLE_DYNAMITE, Particles.PARTICLE_EXPL);
