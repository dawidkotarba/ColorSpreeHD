 ...
 */
public class VioletExtraTile extends ExtraTile {
    public VioletExtraTile(SpriteBatch spriteBatch) {
        super(spriteBatch, GraphicUtils.loadAnimation(Animations.ANIMATION_TILE_VIOLET, 1 / 20f), Textures.IMG_VIOLET_ACTIVE_TILE, Particles.PARTICLE_VIOLET_SMALL, Particles.PARTICLE_VIOLET);
